...
export function PersonalForm () {
    ...
    const validate = values => {
      ...
      return (
        <>
          <div className="persondemoformfull">
            <div className="persondemoformpic">
              <img src={demo} alt="demo" className="persondemoformimg"/>
            </div>
            <div className="persondemoform">
              <h1 className="demoformtitle"> Callback Form </h1>
              ...
              <form onSubmit={sendmail}>
                ...
                {/* Message */}
                <label htmlFor="message" className="contactmessagelabel">Please right about your career aspirations and interests</label>
                <input
                  id="message"
                  name="message"
                  type="text"
